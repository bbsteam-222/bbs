...
<body bgcolor="#FFFFF" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0">
	...
	<div id="middle" class="auto3">	
		...
		<br/>
		<form accept="utf-8" action="${pageContext.request.contextPath}/examinePosts.action?tstatus=${topic.tstatus}&&tid=${topic.tid}" class="publish" id="new_topic" method="post" novalidate="novalidate">
			<div class="detailed">
				<table cellspacing="0" cellpadding="0" width="100%">
						<tbody>
							...
							<tr>
								...
								<td class="right">
									<div class="pub">
										<input type="radio" name = "button" id ="radio1" value="同意">同意
											<input type="radio" name = "button" id ="radio2" value="不同意">不同意
											<input class="btn_b2" id="revise_submit2" name=" btn_submit2" type="submit" value="确定" style="margin-top: 10px">
									</div>
								</td>
							</tr>
