...
<form class="my" bgcolor="#FFFFF" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0">
	<div class="header">
                        ...
                        <div class="wrap">
                            <form action=".../search" method="get" target="_blank">
                                ...
                                <div class="border">
                                    ...
                                    &lt;%&ndash;<input type="button" name="exit" placeholder="退出" accesskey="2">&ndash;%&gt;
						...
						<div class="wrap clearfix">
							<dl>
								<dt style="border:none;">
									<a href="<c:url value='/topicSubmit.action'/>" target="_blank" class="p-doc clearfix">
										<em class="icon"></em>
										<span>发帖</span>
									</a>
								</dt>
						...
						<div class="bd">
							<dl class="clearfix">
								<dd class="info" style="border:none;">
									<span class="dec">
										<a href="<c:url value='/quick.action'/>" class="fill-dec" target="_blank">退出</a>
	...
	<div class="auto4">
		<%--<form name="fm" id="fm" action="${pageContext.request.contextPath}/showDetails.action?title=${item.title}" method="post">--%>
		<div class="person_info_con">
			...
			<dl class="person_info">
				<dt class="username">
					<span>moderator：${sessionScope.sessionUser.username}</span>
				</dt>
				...
				<dd>
					<%--<form name="fm" id="fm" action="${pageContext.request.contextPath}/showPostsByBlock.action" method="post">--%>
					<b>所属板块<input type="text" name="block" id="block" value="${sessionScope.modeBlock}"/></b>
					...
					<%--<span><a href="<c:url value='/showBlockAllUser.action?block='/>" style="width:449px;margin-right:30px ">
                        确定</a><br/></span>--%>
					<span>(您是版主，有以下权限）</span>
					<%--<input type="submit" name="btn3" value="点击显示本版块所有帖子并进行相应操作"/>--%>
					<%--</form>--%>
				</dd>
		...
		<div class="persion_selection">
			<div id="warp" class="person_detail_tab">
				<ul id="tag">
					...
					<%--<li data-modal="tab"><a href="<c:url value='/showPostsByBlock.action'/>">帖子管理</a></li>--%>
				...
				<div id="tagContent">
					...
					<div class="J_tabClass"> <!--用户发出的对某个帖子的评论，某某某应该是帖子的名字-->
						...
						<div class="A">
							<%--<form name="fm" id="fm" action="${pageContext.request.contextPath}/showDetails.action?title=${item.title}" method="post">--%>
							<c:forEach items="${sessionScope.sessionPostsByBlock}" var="item">
								<tr>
									<td><a href="<c:url value='/showDetails.action?title=${item.title}&&context=${item.context}'/>" >
										<input type="text" name="title" id="title" value="${item.title}" style="margin-right:240px "></a></td>
									<td><input type="hidden" name="context" id="context" value="${item.context }"/></td>
									<span class="pipe">|</span>
									<a href="<c:url value='/showDetails.action?title=${item.title}'/>" style="margin-left: 50px" >
										<input type="button" name="check" id="check" value="审核"
											<%--<c:choose>
                                             <c:when test="${tstatus!=0}">
										...
										/></a>
									<span class="pipe">|</span>
									<input type="button" name="modify"  value="更改" disabled="true" style="background: #5e5e5e"/>
									<span class="pipe">|</span>
									<td> <input type="button" name="delete" value="删除"  disabled="true" style="background: #5e5e5e"  /></td>
